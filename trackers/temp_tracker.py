...
class Tracker:
    ...
    def update(self, detections):
        ...
        self.tracks = [t for t in self.tracks if not t.is_deleted()] # TODO modify this to manage track id here
        # TODO make every thing above in father and each child call super(detections)
    ...
    def _match(self, detections):
        ...
        def gated_metric(tracks, dets, track_indices, detection_indices):
            ...
            # the cost"cosine distance or cosine similarity" between each track and each feature
            cost_matrix = self.metric.distance(features, targets)
            cost_matrix = linear_assignment.gate_cost_matrix(  # the gated cost "cosine dist" between track and feature
                self.kf,
                cost_matrix,
                tracks,
                dets,
