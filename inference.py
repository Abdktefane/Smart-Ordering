...
def parse_label_id_mapping(label_id_mapping: Union[Text, Dict[int, Text]] = None) -> Dict[int, Text]:
    ...
    def export(self,
        ...
        if tensorrt:
            from tensorflow.python.compiler.tensorrt import \
                trt  # pylint: disable=g-direct-tensorflow-import,g-import-not-at-top
